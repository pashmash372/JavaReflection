...
import org.example.init.ServerConfiguration;
...
public class WebServer {
    ...
    public void startServer() throws IOException {
        ...
        System.out.printf("Starting server on address %s:%d%n", ServerConfiguration.getInstance().getServerAddress().getHostName(), ServerConfiguration.getInstance().getServerAddress().getPort());
